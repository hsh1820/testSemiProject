...
<head>
  ...
  <link href="http://localhost:8080/searchfree/adminResources/css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top" class="sidebar-toggled">
          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4 border-left-primary">
              ...
              <span class="card-body ">
                ...
                <span>
                  신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용신고내용
                </span>
                <!-- 관리 버튼 -->
                <div id="admin btn" class="float-right py-sm-4 ">
                  <a href="#" class="btn btn-primary btn-icon-split"><span class="text"><i
                        class="fas fa-arrow-left"></i>&nbsp;이전으로</span></a>
                  <a href="#" class="btn btn-warning btn-icon-split"><span class="text"><i
                        class="fas fa-check"></i>&nbsp;완료</span></a>
                </div>
            </div>
  ...
  <script src="http://localhost:8080/searchfree/adminResources/vendor/jquery/jquery.min.js"></script>
  <script src="http://localhost:8080/searchfree/adminResources/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Core plugin JavaScript-->
  <script src="http://localhost:8080/searchfree/adminResources/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="http://localhost:8080/searchfree/adminResources/js/sb-admin-2.min.js"></script>

  <!-- Page level plugins -->
  <script src="http://localhost:8080/searchfree/adminResources/vendor/datatables/jquery.dataTables.min.js"></script>
  <script src="http://localhost:8080/searchfree/adminResources/vendor/datatables/dataTables.bootstrap4.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="http://localhost:8080/searchfree/adminResources/js/demo/datatables-demo.js"></script>
