...
<body id="page-top" class="sidebar-toggled">
						...
						<div class="card-body">
							<div class="text-center">
								<img class="img-fluid px-3 px-sm-4 mt-3 mb-4"
									style="width: 25rem;"
									src="http://localhost:8080/searchfree/adminResources/img/undraw_confirmation_2uy0.svg"
									alt="">
							</div>
	...
	<!-- Page level plugins -->
	<script
		src="http://localhost:8080/searchfree/adminResources/vendor/chart.js/js/Chart.min.js"></script>

	<!-- Page level custom scripts -->
	<script
		src="http://localhost:8080/searchfree/adminResources/js/demo/chart-area-demo.js"></script>
	<script
		src="http://localhost:8080/searchfree/adminResources/js/demo/chart-pie-demo.js"></script>
